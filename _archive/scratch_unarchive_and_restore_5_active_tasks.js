...
if (fs.existsSync(dbFile)) {
  ...
  if (o155) {
    o155.archived = false;
    o155.archivedAt = null;
    if (o155.status === 'Archivada') o155.status = 'Pendiente';
    ...
    console.log("✅ Un-archived and updated Order 155!");
  }
  ...
  if (o119) {
    o119.archived = false;
    o119.archivedAt = null;
    if (o119.status === 'Archivada') o119.status = 'Pendiente';
    ...
    console.log("✅ Un-archived and updated Order 119!");
  }
  ...
  conn.sftp((err, sftp) => {
    ...
    sftp.fastPut('./db.json', '/home/cbelocures/data/db.json', (err1) => {
      sftp.fastPut('./syncWorker.js', '/home/cbelocures/gestion/syncWorker.js', (err2) => {
        console.log("✅ Uploaded db.json & syncWorker.js to 192.168.50.4!");
