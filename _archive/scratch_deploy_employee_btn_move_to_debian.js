...
async function run() {
  ...
  conn.on('ready', () => {
    conn.sftp(async (err, sftp) => {
      ...
      console.log("=== DEPLOYING EMPLOYEE BUTTON MOVE TO AJUSTES TO DEBIAN ===");
      await uploadFile(sftp, 'public/index.html', '/home/cbelocures/gestion/public/index.html');
      console.log("  ✅ Uploaded public/index.html!");
