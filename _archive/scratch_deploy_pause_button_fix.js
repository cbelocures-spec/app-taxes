...
console.log("Committing and pushing dashboard pause button fix to Railway...");
try {
  execSync('git add public/app.js', { stdio: 'inherit' });
  execSync('git commit -m "Fix toggleDashboardTaskTimer so clicking Pausar properly pauses the timer and clears localStorage"', { stdio: 'inherit' });
  execSync('git push origin master', { stdio: 'inherit' });
  console.log("✅ Successfully pushed pause button fix to Railway!");
} catch (e) {
